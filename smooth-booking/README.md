...
- Visit **Smooth Booking → Calendar** to inspect location schedules at a glance in a day-based EventCalendar view that defaults to today, rendering employee resources as columns, applying service colours to each appointment, and letting you switch locations or dates with lightweight native controls.
