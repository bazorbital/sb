...
- Calendar workspace powered by the EventCalendar library, showing per-location employee columns, configurable time-slot length, service-coloured appointments, inline booking modal, quick edit/delete affordances, and Select2-powered location/service/employee filters with default “All services” and “All employees” options plus chip-style employee toggles
